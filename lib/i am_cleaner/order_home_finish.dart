...
import 'package:service_app/i%20am_cleaner/direction_screen.dart';

import 'Bottom_sheets/bottomsheet1.dart';

class HomwOrderFinish extends StatefulWidget {
  const HomwOrderFinish({Key? key}) : super(key: key);

  @override
  State<HomwOrderFinish> createState() => _HomwOrderFinishState();
}
...
class _HomwOrderFinishState extends State<HomwOrderFinish> {
  displayBottomSheetthree(BuildContext context) {
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage('assets/icons/upload1.png')),
                      ),
                    ),
                    Container(
                      height: configSize(context).height * 0.135,
                ...
                Positioned(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                      ...
                      left: ConfigSize(context).height * 0.016,
                      right: ConfigSize(context).height * 0.016,
                    ),
                    child: Card(
                      elevation: 4,
                      child: Container(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    displayBottomSheetthree(context);
                                  },
                                  child: Container(
                                    alignment: Alignment.center,
